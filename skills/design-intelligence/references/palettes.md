...
Ratios 55/30/12/3. Dark: paper->#241812, ink->#EFE2D3, accent->#D97F52.

## Adobe Clay (earthy warm - artisan, food, craft retail)
#2E2620 ink | #F5EEE2 paper | #B4552F accent | #8C9A5B warn
Ratios 52/33/12/3. Dark: paper->#1C1712, ink->#E8DECC, accent->#C56A42.

## Obsidian Ledger (dark-first - fintech terminals, trading)
#0D0F12 base | #E4E7EB text | #3DDC97 accent | #F5A623 warn
Ratios 65/25/7/3. Light flip: base->#F5F6F7, text->#14171A, accent unchanged.

## Nightshift Console (dark-first - devtools, monitoring)
#0A0E14 base | #C9D1D9 text | #58A6FF accent | #F85149 warn
Ratios 68/22/7/3. Light flip: base->#FFFFFF, text->#1B1F24, accent->#0969DA.

## Powder Studio (pastel - design tools, portfolios)
#2B2B33 ink | #FDF6FB paper | #B18CD9 accent | #F4A5A5 warn
Ratios 15/68/14/3. Dark: paper->#232128, ink->#EDE7F2, accent->#C7A6E3.

## Mint Nursery (pastel - kids, education, baby brands)
#2A3A36 ink | #F6FBF8 paper | #8FD4B8 accent | #F7C978 warn
Ratios 16/67/14/3. Dark: paper->#1B2523, ink->#DCEEE6, accent->#6FBE9C.
